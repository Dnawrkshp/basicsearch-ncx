...
{
    class GreaterThanOrEqualTo : ISearchMethod
    {
        ...
        public string Description { get; } = "If values within memory range are greater than or equal to parameter0.";

        public string Name { get; } = "Greater Than Or Equal To";
        ...
        public void FirstScan(out List<ISearchResult> result, ISearchType searchType, object[] args, Types.MemoryRange[] range, Types.SetProgressCallback setProgress)
        {
            ...
            {
                Search.FirstScan(_host, this, setProgress, r, ref result, Search.SearchType.GreaterThanOrEqualTo, searchType.Signed, searchType.Alignment, param0);
            }
        }
        ...
        public void NextScan(ref List<ISearchResult> result, ISearchType searchType, object[] args, Types.SetProgressCallback setProgress)
        {
            ...
            // Perform scan
            Search.NextScan(_host, this, setProgress, ref result, Search.SearchType.GreaterThanOrEqualTo, sign, param0);
        }
